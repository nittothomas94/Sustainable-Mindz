const Platform = () => {
  return (
    <div className="min-h-100 border mt-40 flex flex-col items-center gap-10 pt-6 md:items-start md:px-[194px] md:py-10">
      <h1 className="font-bold text-[29px] md:text-[39px]">
        Platform Benefits
      </h1>

      <div className="w-full">
        <div className="flex items-center px-2 gap-3 w-full md:my-4">
        ...
        <div className="flex items-center px-2 gap-3  w-full border-y-1 border-gray-200 md:py-4">
          <i className="size-8 flex items-center justify-center font-bold bg-gray-400 rounded-4xl">
            2
          </i>
        ...
        <div className="flex flex-col px-3 py-5 gap-4 w-full  border-y-1 border-gray-200 h-[432px] md:py-4 md:flex-row md:gap-40">
          <div>
            <div className="flex">
          ...
          <img
            ...
            alt="girl magini"
            className="size-[300px] object-contain md:w-[410px] md:h-[400px] border"
          />
        </div>
